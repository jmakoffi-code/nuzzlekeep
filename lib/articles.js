...
export const articles = [
  {
    ...
    diagram: {
      src: "/diagrams/dog-nail-anatomy.svg",
      alt: "Diagram comparing a light dog nail (where the pink quick is visible) and a dark dog nail (where it isn't), with the safe cut line marked on each.",
      caption: "Where the quick sits on light vs. dark nails, and the safe zone to trim.",
      width: 640,
      height: 320,
    },
    stepList: [
  ...
  },
  {
    ...
    quickFacts: [
      ...
      { label: "Key move", value: "Yelp + redirect" },
      { label: "Relapse risk", value: "Teething weeks" },
    ],
    stepList: [
      {
    ...
    related: ["crate-train-puppy", "first-48-hours-puppy", "stop-dog-jumping-on-guests"],
  },
  {
    ...
    quickFacts: [
      { label: "Start distance", value: "Indoors/backyard" },
      { label: "Key rule", value: "Never call to punish" },
      { label: "Treat value", value: "Save best for recall" },
    ],
    stepList: [
      {
    ...
    related: ["stop-puppy-biting", "crate-train-puppy", "what-your-pet-finds-rewarding"],
  },
  {
    ...
    quickFacts: [
      { label: "Max time crated", value: "Age (mo) + 1 hr" },
      { label: "Open-door phase", value: "3-5 days" },
      { label: "Full workday", value: "2-4 wks buildup" },
    ],
    stepList: [
      {
    ...
    related: ["stop-puppy-biting", "first-48-hours-puppy", "dog-separation-anxiety"],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Do they need to become best friends?",
        a: "No. Calm coexistence, sharing space without conflict, is a realistic and completely fine outcome. Not every cat pairing turns into a close bond, and that's not a sign anything went wrong.",
      },
    ],
    related: ["stop-cat-scratching-furniture", "litter-train-rescue-cat", "introduce-new-pet-multi-pet-household"],
  },
  {
    ...
    diagram: {
      src: "/diagrams/cat-tail-positions.svg",
      alt: "Diagram of five cat tail positions: up and curved, puffed bottle-brush, low and tucked, slow wide swish, and fast flicking, each labeled with its meaning.",
      caption: "Five tail positions and what they're actually telling you.",
      width: 780,
      height: 280,
    },
    sections: [
    ...
    related: ["introduce-two-cats", "trim-dog-nails-safely", "cat-belly-bite-behavior", "why-cats-bring-dead-bugs-toys", "why-does-my-cat-meow-at-night"],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The general guideline is one per cat plus one extra, placed in different locations. This matters even more for a rescue still building trust in the space.",
      },
    ],
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Sleep needed", value: "18-20 hrs/day" },
      { label: "First vet visit", value: "Within 1 wk" },
      { label: "Settling time", value: "24-48 hrs" },
    ],
    faqs: [
      {
      ...
      {
        q: "Should visitors meet the puppy right away?",
        a: "Better to hold off for the first day or two. A quieter household while they settle makes the adjustment easier than a stream of new faces on day one.",
      },
    ],
    related: ["crate-train-puppy", "stop-puppy-biting", "introduce-dog-to-new-baby", "socialize-puppy-before-vaccines", "adopting-vs-buying-a-puppy", "celebrate-pet-adoption-anniversary"],
  },
  {
    ...
    quickFacts: [
      { label: "Time needed", value: "~1 hour" },
      { label: "Top hazard", value: "Cords & lilies" },
      { label: "Check height", value: "Kitten-level" },
    ],
    faqs: [
      {
      ...
      {
        q: "Do I need to redo this once they're grown?",
        a: "Most of it stays relevant, though adult cats are less likely to chew cords or fit into tiny gaps. Toxic plants and cabinet latches remain worth keeping in place long-term regardless of age.",
      },
    ],
    related: ["litter-train-rescue-cat", "choose-right-vet", "pet-safe-christmas-hazards-guide"],
  },
  {
    ...
    quickFacts: [
      { label: "Clinics to call", value: "2-3" },
      { label: "Time per call", value: "~10 min" },
      { label: "Key question", value: "Emergency coverage" },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Ideally before you need it, right after bringing a pet home. Scrambling to find a vet during an actual emergency limits your options to whichever clinic can see you fastest.",
      },
    ],
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Biggest cost", value: "Initial vet visit" },
      { label: "Buy once", value: "Crate, bed, bowls" },
      { label: "Easy to forget", value: "Flea/tick prevention" },
    ],
    stepList: [
      {
    ...
    related: ["choose-right-vet", "first-48-hours-puppy", "choose-pet-insurance"],
  },
  {
    ...
    diagram: {
      src: "/diagrams/double-coat-brushing.svg",
      alt: "Diagram showing two brushing passes: an undercoat rake worked against the direction of hair growth first, followed by a slicker brush worked with the direction of hair growth to finish.",
      caption: "The order matters as much as the tools: rake against the lay, then slicker with it.",
      width: 720,
      height: 280,
    },
    quickFacts: [
      { label: "Tool order", value: "Rake → slicker" },
      { label: "Frequency", value: "Weekly, daily in shed season" },
      { label: "Never shave", value: "Double coats" },
    ],
    stepList: [
      {
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Water temp", value: "Lukewarm" },
      { label: "Never use", value: "Human shampoo" },
      { label: "Bath frequency", value: "Every 4-6 wks" },
    ],
    stepList: [
      {
    ...
    related: ["brush-double-coated-breed", "clean-dog-ears-at-home", "how-often-bathe-dog"],
  },
  {
    ...
    quickFacts: [
      { label: "Higher risk", value: "Floppy ears, swimmers" },
      { label: "Never use", value: "Cotton swabs" },
      { label: "Frequency", value: "Weekly to monthly" },
    ],
    stepList: [
      {
  ...
  },
  {
    ...
    diagram: {
      src: "/diagrams/body-condition-score.svg",
      alt: "Diagram comparing three dog body outlines: too thin with visible ribs and severe waist tuck, ideal weight with an easily felt but not visible waist, and overweight with no visible waist and a rounded abdomen.",
      caption: "The three-second body check: too thin, ideal, and overweight, side by side.",
      width: 700,
      height: 300,
    },
    stepList: [
    ...
    quickFacts: [
      { label: "Safe loss rate", value: "1-2% body wt/wk" },
      { label: "Rib check", value: "Feel w/o pressing" },
      { label: "Waist check", value: "Visible from above" },
    ],
    faqs: [
      {
      ...
      {
        q: "Are some breeds just naturally heavier-looking?",
        a: "Yes, build varies a lot by breed, which is exactly why the hands-on rib and waist check matters more than comparing a dog's weight to a generic breed chart.",
      },
    ],
    related: ["brush-dog-teeth-at-home", "senior-dog-comfort-at-home", "why-do-dogs-eat-grass", "dog-overheating-on-walk", "flea-tick-prevention-that-works"],
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Does dry food clean teeth on its own?",
        a: "Only marginally. The mechanical crunching helps a little, but it's nowhere near enough to replace brushing or prevent tartar buildup on its own.",
      },
    ],
  ...
  },
  {
    ...
    related: ["read-cat-tail-language", "litter-train-rescue-cat", "cat-not-drinking-enough-water", "cat-hiding-more-than-usual"],
  },
  {
    ...
    quickFacts: [
      { label: "Priority item", value: "Orthopedic bed" },
      { label: "Watch for", value: "Slippery floors" },
      { label: "Consider", value: "Ramps for furniture/car" },
    ],
    stepList: [
      {
    ...
    related: ["healthy-weight-for-dogs", "brush-dog-teeth-at-home", "adopting-senior-dog-first-month", "choose-dog-bed-joint-support"],
  },
  {
    ...
    diagram: {
      src: "/diagrams/crate-sizing.svg",
      alt: "Diagram of a dog inside a crate showing the two key space requirements: enough height to stand fully upright, and enough length to turn around and lie down stretched out.",
      caption: "The only two measurements that actually matter.",
      width: 640,
      height: 280,
    },
    comparisonTable: {
      caption: "Crate types, compared",
      columns: ["Wire", "Plastic", "Soft-sided"],
      rows: [
        { label: "Airflow/visibility", values: ["Best", "Moderate", "Good"] },
        { label: "Den-like feel", values: ["Least", "Most", "Moderate"] },
        { label: "Durability", values: ["High", "High", "Lower, chewable"] },
        { label: "Portability", values: ["Heavier, some fold flat", "Airline-approved options", "Lightest, foldable"] },
        { label: "Best for", values: ["Home use, house-training", "Anxious dogs, travel", "Calm dogs, occasional travel"] },
      ],
    },
    stepList: [
      {
  ...
  },
  {
    ...
    diagram: {
      src: "/diagrams/litter-box-sizing.svg",
      alt: "Diagram showing that a litter box should be at least 1.5 times the length of the cat from nose to base of tail, illustrating that most store-bought boxes are sized too small.",
      caption: "The size rule most litter box problems trace back to.",
      width: 640,
      height: 280,
    },
    comparisonTable: {
      caption: "Litter types, compared",
      columns: ["Clumping clay", "Crystal", "Pine/paper"],
      rows: [
        { label: "Odor control", values: ["Good", "Very good", "Moderate"] },
        { label: "Dust level", values: ["Moderate to high", "Low", "Low"] },
        { label: "Change frequency", values: ["Weekly full change", "2-4 weeks", "Weekly full change"] },
        { label: "Tracking", values: ["Moderate", "Low", "Low"] },
        { label: "Best for", values: ["Most cats, default choice", "Low-mess households", "Sensitive cats, eco preference"] },
      ],
    },
    stepList: [
      {
    ...
    related: ["litter-train-rescue-cat", "pick-safe-chew-toys", "choose-cat-tree"],
  },
  {
    ...
    comparisonTable: {
      caption: "Toy material by chewing strength",
      columns: ["Light chewer", "Moderate chewer", "Aggressive chewer"],
      rows: [
        { label: "Best material", values: ["Plush, rope", "Nylon, dense rubber", "Solid rubber, reinforced nylon"] },
        { label: "Avoid", values: ["N/A", "Thin plastic", "Anything hollow or stuffed"] },
        { label: "Typical lifespan", values: ["Weeks", "1-2 months", "Months, if rated correctly"] },
        { label: "Check frequency", values: ["Monthly", "Every 2 weeks", "Weekly"] },
      ],
    },
    stepList: [
      {
  ...
  },
  {
    ...
    related: ["golden-retriever-breed-guide", "german-shepherd-breed-guide", "chihuahua-breed-guide"],
  },
  {
    ...
    related: ["french-bulldog-breed-guide", "teach-recall-off-leash", "border-collie-breed-guide"],
  },
  {
    ...
    related: ["maine-coon-breed-guide", "read-cat-tail-language", "bengal-breed-guide"],
  },
  {
    ...
    related: ["domestic-shorthair-breed-guide", "introduce-two-cats", "ragdoll-breed-guide"],
  },
  {
    ...
    quickFacts: [
      { label: "Time to see change", value: "2-3 weeks" },
      { label: "Best gear", value: "Front-clip harness" },
      { label: "Avoid", value: "Retractable leads" },
    ],
    diagram: {
      src: "/diagrams/leash-stop-and-wait.svg",
      alt: "Diagram comparing a tight leash, where the owner stops walking, against a loose leash, where the walk continues, illustrating the stop-and-wait training method.",
      caption: "The whole method in one picture: tight leash stops the walk, loose leash continues it.",
      width: 640,
      height: 300,
    },
    stepList: [
    ...
    related: ["teach-recall-off-leash", "pick-harness-vs-collar", "crate-train-puppy", "best-leash-harness-for-pulling-dogs", "stop-puppy-pulling-on-leash", "stop-leash-pulling-fast"],
  },
  {
  ...
  },
  {
    ...
    related: ["read-cat-tail-language", "litter-train-rescue-cat", "trim-dog-nails-safely", "trim-cat-whiskers", "clean-cat-ears-at-home"],
  },
  {
    ...
    related: ["trim-cat-nails-safely", "read-cat-tail-language", "brush-double-coated-breed", "deshed-cat-shedding-season"],
  },
  {
    ...
    related: ["healthy-weight-for-dogs", "choose-right-size-crate", "first-month-budget", "read-dog-food-label-like-a-vet"],
  },
  {
    ...
    sections: [
      {
        heading: "A leftover nesting instinct",
      ...
      {
        heading: "Paw pads leave scent behind",
      ...
      {
        heading: "When it's worth watching",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Try the skin tent test",
      ...
      {
        heading: "Watch litter box output",
      ...
      {
        heading: "Move water away from food and litter",
      ...
      {
        heading: "Switch to a wide, shallow bowl",
      ...
      {
        heading: "Add moisture through food and a fountain",
  ...
  },
  {
    ...
    related: ["dog-circling-before-lying-down", "teach-recall-off-leash", "do-dogs-dream", "why-dogs-tilt-head"],
  },
  {
  ...
  },
  {
    ...
    comparisonTable: {
      caption: "Matching a tree to life stage",
      columns: ["Kitten", "Adult", "Senior"],
      rows: [
        { label: "Platform height", values: ["Low, close together", "Tall, varied levels", "Low to moderate"] },
        { label: "Jump distance", values: ["Short", "Can handle longer", "Short, gentle ramps help"] },
        { label: "Priority feature", values: ["Stability, soft landings", "Height, scratching surfaces", "Easy entry, enclosed cubby"] },
      ],
    },
    stepList: [
      {
  ...
  },
  {
    ...
    diagram: {
      src: "/diagrams/stay-training-progression.svg",
      alt: "Diagram showing the three training stages for stay in order: duration first, distance second, distraction last, with a note that stacking two variables at once is why stay training usually stalls.",
      caption: "One variable at a time: duration, then distance, then distraction.",
      width: 700,
      height: 260,
    },
    quickFacts: [
      { label: "Train in order", value: "Duration → Distance → Distraction" },
      { label: "Solid stay", value: "30-60+ sec" },
      { label: "Common error", value: "Stacking distance + duration" },
    ],
    stepList: [
      {
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Pavement test", value: "5 sec hand test" },
      { label: "Higher risk", value: "Flat-faced, senior, overweight" },
      { label: "Safer times", value: "Early AM / evening" },
    ],
    sections: [
      {
        heading: "Heavy, frantic panting",
      ...
      {
        heading: "Wobbliness or disorientation",
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Biggest red flag", value: "Won't allow a visit" },
      { label: "Always ask about", value: "Health testing" },
      { label: "Green flag", value: "Asks you questions too" },
    ],
    stepList: [
      {
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Check first", value: "Reimbursement %" },
      { label: "Excluded always", value: "Pre-existing conditions" },
      { label: "Best time to buy", value: "While young/healthy" },
    ],
    sections: [
      {
  ...
  },
  {
    ...
    comparisonTable: {
      caption: "Bed types for joint support, compared",
      columns: ["Memory foam", "Bolstered", "Heated"],
      rows: [
        { label: "Best for", values: ["General joint/pressure relief", "Dogs who like to lean or nest", "Cold rooms, stiff mornings"] },
        { label: "Entry ease", values: ["Low-profile, easy", "Can have raised edges", "Varies by base design"] },
        { label: "Typical lifespan", values: ["2-3 years before support fades", "Varies by fill", "Check cord/element separately"] },
        { label: "Washability", values: ["Removable covers common", "Removable covers common", "Cover only, not heating element"] },
      ],
    },
    stepList: [
      {
  ...
  },
  {
    ...
    related: ["siamese-cat-breed-guide", "maine-coon-breed-guide", "poodle-breed-guide"],
  },
  {
  ...
  },
  {
    ...
    quickFacts: [
      { label: "Check first", value: "AAFCO statement" },
      { label: "Ignore", value: "\"Premium\", \"holistic\"" },
      { label: "Ingredients listed by", value: "Weight" },
    ],
    sections: [
      {
  ...
  },
  {
    ...
    comparisonTable: {
      caption: "Adoption vs. buying, at a glance",
      columns: ["Adoption", "Reputable breeder"],
      rows: [
        { label: "Upfront cost", values: ["Lower, often includes vetting", "Higher, plus a deposit"] },
        { label: "Wait time", values: ["Often immediate", "Weeks to months, by litter"] },
        { label: "Temperament predictability", values: ["Moderate, foster staff can help", "High, from birth"] },
        { label: "Health/genetic history", values: ["Often unknown, especially mixed breed", "Documented, parents health-tested"] },
      ],
    },
    sections: [
      {
  ...
  },
  {
    ...
    comparisonTable: {
      caption: "Gear options for pulling, compared",
      columns: ["Front-clip harness", "Head halter", "Back-clip (avoid for pulling)"],
      rows: [
        { label: "Control level", values: ["Moderate", "Highest", "Lowest, can worsen pulling"] },
        { label: "Adjustment period", values: ["Minimal", "A few sessions", "None needed"] },
        { label: "Best for", values: ["Most moderate pullers", "Large, strong, determined pullers", "Well-mannered walkers only"] },
        { label: "Injury risk if misused", values: ["Low", "Low, if fitted correctly", "N/A"] },
      ],
    },
    stepList: [
      {
  ...
  },
  {
    ...
    related: ["healthy-weight-for-dogs", "choose-right-size-crate", "pet-stocking-stuffers-under-10"],
  },
  {
  ...
  },
  {
    ...
    related: ["choose-right-size-crate", "choose-cat-litter", "christmas-gifts-for-dog-lovers-2026"],
  },
  {
  ...
  },
  {
    ...
    diagram: {
      src: "/diagrams/absence-training-timeline.svg",
      alt: "Timeline diagram showing gradual increases in absence duration over 6 to 8 weeks: 2-3 minutes in week 1, 15-20 minutes in week 2, 1 hour by weeks 3-4, half a day by weeks 5-6, and a full day by week 6-8 or later.",
      caption: "A realistic pace: each jump only happens once your dog is calm at the current length.",
      width: 700,
      height: 280,
    },
    stepList: [
    ...
    related: ["crate-train-puppy", "teach-dog-to-settle", "stop-puppy-biting", "stop-dog-barking-at-door", "dog-scared-of-thunderstorms"],
  },
  {
